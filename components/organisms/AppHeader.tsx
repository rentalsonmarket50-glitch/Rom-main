          ...
          >
            {searchPage ? (
              <span className="flex-grow text-sm font-medium tracking-wide text-gray-500">
                <span className="px-4 py-1 border-r border-gray-200">
                  {query.location || (
                ...
                <span className="px-4 py-1 border-r border-gray-200">
                  {query.propertyType || (
                    <span className="font-normal text-gray-300">Property Type</span>
                  )}
                </span>
                <span className="px-4 py-1">
                  {query.select || (
                    <span className="font-normal text-gray-300">Select</span>
                  )}
                </span>
              </span>
            ) : (
